...
import com.dnamedical.Activities.IdVerificationActivitty;
...
public class CameraUtils {
    ...
    public static File getOutputMediaFile(int type) {
        ...
        File mediaStorageDir = new File(
               ...
               IdVerificationActivitty.GALLERY_DIRECTORY_NAME);

        // Create the storage directory if it does not exist
        if (!mediaStorageDir.exists()) {
            if (!mediaStorageDir.mkdirs()) {
                Log.e(IdVerificationActivitty.GALLERY_DIRECTORY_NAME, "Oops! Failed create "
                        + IdVerificationActivitty.GALLERY_DIRECTORY_NAME + " directory");
                return null;
            }
        }
        ...
        File mediaFile;
        if (type == IdVerificationActivitty.MEDIA_TYPE_IMAGE) {
            mediaFile = new File(mediaStorageDir.getPath() + File.separator
                    + "IMG_" + timeStamp + "." + IdVerificationActivitty.IMAGE_EXTENSION);
        }  else {
            return null;
        }
